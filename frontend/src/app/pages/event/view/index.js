...
export default function ViewsEvent() {
  ...
  useEffect(() => { //fetch the api to get information about the session
      ...
      <Row>
        <Col lg="3" sm="12">
          <Card className={style.CreatorCard}>
            ...
            <ProfileRound size="Big" bgcolor="red" letter="t" fcolor="#fff" />
            <CardBody>
        ...
        <Col lg="9" sm="12">
          <Card>
            ...
            <CardBody>
              <h1>
                Base de donnée <Badge theme="success">TP</Badge>
              </h1>
              <div
              ...
              <Collapse open={eventCollapse}>
                <div className="table-responsive">
                  <table className={`table table-striped ${style.EventTable}`}>
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>00h30</td>
                        <td>
                          <Badge theme="warning">a faire</Badge>
                        </td>
                        <td style={{ textAlign: "center" }}>
